...
-- Documents table - stores information about ingested documents
...
-- Document chunks table - stores individual chunks of documents
...
-- Queries table - tracks user queries and results
...
-- Document processing jobs table - tracks ingestion pipeline
...
-- Document tags table - for categorization
...
-- Session table - for query sessions and conversation history
...
-- Session queries table - for conversation history
